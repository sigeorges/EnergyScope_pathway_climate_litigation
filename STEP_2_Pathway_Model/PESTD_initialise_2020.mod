...
subject to no_gas_RE_import_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (   F_t ['YEAR_2020','GAS_RE', h , td] ) = 0;
...
### shares high T heat ###
# SOURCE: As done by GL for 2015
let fmin_perc['YEAR_2020',"IND_BOILER_GAS"] := 0.573;#0.358;#
let fmin_perc['YEAR_2020',"IND_BOILER_COAL"] := 0.132;#0.3;#
let fmin_perc['YEAR_2020',"IND_BOILER_OIL"] := 0.214;#0.2;#
let fmin_perc['YEAR_2020',"IND_COGEN_GAS"] := 0.055;#0.086;#
let fmin_perc['YEAR_2020',"IND_COGEN_WASTE"] := 0.0092;#0.056;#
let fmin_perc['YEAR_2020', "IND_BOILER_WASTE"] := 0.0167;
